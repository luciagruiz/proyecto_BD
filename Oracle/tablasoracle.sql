CREATE TABLE USUARIO (
    ...
    direccion_envio VARCHAR2(20),
    direccion_facturacion VARCHAR2(20),
    correo_electronico VARCHAR2(50),
    login VARCHAR2(20) NOT NULL,
    password VARCHAR2(20) NOT NULL,
    CONSTRAINT pk_usuario PRIMARY KEY (DNI),
    CONSTRAINT chk_password CHECK (REGEXP_LIKE(password, '[A-Z]', 'c')),
    CONSTRAINT chk_dni_formato CHECK (REGEXP_LIKE(DNI, '^[0-9]{8}[a-zA-Z]{1}$'))
);

CREATE TABLE DOCUMENTO (
    cod_documento VARCHAR2(10),
...
CREATE TABLE INFORME_TECNICO (
    ...
    anio DATE DEFAULT TO_DATE('2023-01-01', 'YYYY-MM-DD'),
    tipo VARCHAR2(20),
    ...
    CONSTRAINT chk_anio CHECK (anio BETWEEN TO_DATE('2000-01-01', 'YYYY-MM-DD') AND TO_DATE('2023-12-31', 'YYYY-MM-DD'))
);
...
CREATE TABLE LIBRO (
    ...
    edicion NUMBER DEFAULT 1,
    sinapsis VARCHAR2(50),
...
CREATE TABLE AUTOR (
    cod_autor VARCHAR2(9),
    nombre VARCHAR2(20) NOT NULL,
    apellido1 VARCHAR2(20) NOT NULL,
    apellido2 VARCHAR2(50),
    fecha_nacimiento DATE,
    edad NUMBER(3),
    localidad VARCHAR2(20) CHECK (localidad IN ('Madrid', 'Barcelona', 'Sevilla', 'Valencia')),
    CONSTRAINT pk_autor PRIMARY KEY (cod_autor)
);

CREATE TABLE CATEGORIA (
    cod_categoria VARCHAR2(10),
    nombre_categoria VARCHAR2(20) UNIQUE,
    CONSTRAINT pk_categoria PRIMARY KEY (cod_categoria),
    CONSTRAINT chk_categoria_formato CHECK (REGEXP_LIKE(nombre_categoria, '^[A-Za-z ]+$'))
);
...
INSERT INTO LIBRO (cod_documento, ISBN, fecha_publicacion, editorial, sinapsis) VALUES ('DOC001', '978-3-16-148411-1', TO_DATE('2023-05-20', 'YYYY-MM-DD'), 'Editorial ABC', 'Una apasionante historia sobre...');
INSERT INTO LIBRO (cod_documento, ISBN, fecha_publicacion, editorial, sinapsis) VALUES ('DOC002', '978-3-16-148412-2', TO_DATE('2022-12-15', 'YYYY-MM-DD'), 'Editorial XYZ', 'Un libro que explora el mundo de...');
INSERT INTO LIBRO (cod_documento, ISBN, fecha_publicacion, editorial, sinapsis) VALUES ('DOC003', '978-3-16-148413-3', TO_DATE('2023-02-10', 'YYYY-MM-DD'), 'Editorial 123', 'Una obra fundamental sobre el tema de...');
INSERT INTO LIBRO (cod_documento, ISBN, fecha_publicacion, editorial, sinapsis) VALUES ('DOC004', '978-3-16-148414-4', TO_DATE('2022-08-25', 'YYYY-MM-DD'), 'Editorial XYZ', 'Una obra fundamental que aborda...');
...
INSERT INTO AUTOR (cod_autor, nombre, apellido1, fecha_nacimiento, localidad) VALUES ('AUT003', 'Luis', 'Hernández', TO_DATE('1985-08-25', 'YYYY-MM-DD'), 'Sevilla');
INSERT INTO AUTOR (cod_autor, nombre, apellido1, fecha_nacimiento, localidad) VALUES ('AUT004', 'Carmen', 'Díaz', TO_DATE('1990-03-15', 'YYYY-MM-DD'), 'Valencia');
INSERT INTO AUTOR (cod_autor, nombre, apellido1, fecha_nacimiento, localidad) VALUES ('AUT005', 'Javier', 'Ruiz', TO_DATE('1970-12-01', 'YYYY-MM-DD'), 'Madrid');
INSERT INTO AUTOR (cod_autor, nombre, apellido1, fecha_nacimiento, localidad) VALUES ('AUT006', 'Sergio', 'García', TO_DATE('1978-05-20', 'YYYY-MM-DD'), 'Barcelona');
INSERT INTO AUTOR (cod_autor, nombre, apellido1, fecha_nacimiento, localidad) VALUES ('AUT007', 'Eva', 'Pérez', TO_DATE('1983-11-15', 'YYYY-MM-DD'), 'Valencia');
INSERT INTO AUTOR (cod_autor, nombre, apellido1, fecha_nacimiento, localidad) VALUES ('AUT008', 'Jorge', 'López', TO_DATE('1965-07-01', 'YYYY-MM-DD'), 'Madrid');
...
INSERT INTO FACTURA (id_factura, DNI, fecha) VALUES ('FAC001', '77777777G', TO_DATE('2024-02-15', 'YYYY-MM-DD'));
INSERT INTO FACTURA (id_factura, DNI, fecha) VALUES ('FAC002', '88888888H', TO_DATE('2024-02-14', 'YYYY-MM-DD'));
INSERT INTO FACTURA (id_factura, DNI, fecha) VALUES ('FAC003', '99999999I', TO_DATE('2024-02-13', 'YYYY-MM-DD'));
...
INSERT INTO NO_EDITADO (cod_documento, fecha_lanzamiento) VALUES ('DOC002', TO_DATE('2023-02-15', 'YYYY-MM-DD'));
INSERT INTO NO_EDITADO (cod_documento, fecha_lanzamiento) VALUES ('DOC003', TO_DATE('2023-01-20', 'YYYY-MM-DD'));
INSERT INTO NO_EDITADO (cod_documento, fecha_lanzamiento) VALUES ('DOC006', TO_DATE('2023-03-10', 'YYYY-MM-DD'));
...
INSERT INTO USUARIO_EDITADO (DNI, cod_documento, fecha, cantidad) VALUES ('77777777G', 'DOC004', TO_DATE('2024-02-15', 'YYYY-MM-DD'), 2);
INSERT INTO USUARIO_EDITADO (DNI, cod_documento, fecha, cantidad) VALUES ('88888888H', 'DOC005', TO_DATE('2024-02-14', 'YYYY-MM-DD'), 1);
INSERT INTO USUARIO_EDITADO (DNI, cod_documento, fecha, cantidad) VALUES ('99999999I', 'DOC007', TO_DATE('2024-02-13', 'YYYY-MM-DD'), 3);

-- Inserciones en la tabla USUARIO_INFORME_TECNICO
INSERT INTO USUARIO_INFORME_TECNICO (DNI, cod_documento, fecha) VALUES ('77777777G', 'DOC008', TO_DATE('2024-02-15', 'YYYY-MM-DD'));
INSERT INTO USUARIO_INFORME_TECNICO (DNI, cod_documento, fecha) VALUES ('88888888H', 'DOC009', TO_DATE('2024-02-14', 'YYYY-MM-DD'));
INSERT INTO USUARIO_INFORME_TECNICO (DNI, cod_documento, fecha) VALUES ('99999999I', 'DOC010', TO_DATE('2024-02-13', 'YYYY-MM-DD'));

-- Inserciones en la tabla USUARIO_NO_EDITADO_NOTIFICA
INSERT INTO USUARIO_NO_EDITADO_NOTIFICA (DNI, cod_documento, fecha_peticion) VALUES ('77777777G', 'DOC002', TO_DATE('2024-02-15', 'YYYY-MM-DD'));
INSERT INTO USUARIO_NO_EDITADO_NOTIFICA (DNI, cod_documento, fecha_peticion) VALUES ('88888888H', 'DOC003', TO_DATE('2024-02-14', 'YYYY-MM-DD'));
INSERT INTO USUARIO_NO_EDITADO_NOTIFICA (DNI, cod_documento, fecha_peticion) VALUES ('99999999I', 'DOC006', TO_DATE('2024-02-13', 'YYYY-MM-DD'));

-- Inserciones en la tabla USUARIO_NO_EDITADO_RESERVA
INSERT INTO USUARIO_NO_EDITADO_RESERVA (DNI, cod_documento, fecha_reserva) VALUES ('77777777G', 'DOC002', TO_DATE('2024-02-15', 'YYYY-MM-DD'));
INSERT INTO USUARIO_NO_EDITADO_RESERVA (DNI, cod_documento, fecha_reserva) VALUES ('88888888H', 'DOC003', TO_DATE('2024-02-14', 'YYYY-MM-DD'));
INSERT INTO USUARIO_NO_EDITADO_RESERVA (DNI, cod_documento, fecha_reserva) VALUES ('99999999I', 'DOC006', TO_DATE('2024-02-13', 'YYYY-MM-DD'));
