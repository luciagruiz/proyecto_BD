CREATE TABLE USUARIO (
    ...
    CONSTRAINT chk_password CHECK (password ~ '[A-Z]'),
    CONSTRAINT chk_dni_formato CHECK (DNI ~ '^[0-9]{8}[a-zA-Z]{1}$')
);
...
CREATE TABLE INFORME_TECNICO (
    ...
    anio DATE DEFAULT '2023-01-01'::DATE,
    tipo VARCHAR(20),
    ...
    CONSTRAINT chk_anio CHECK (anio BETWEEN '2000-01-01'::DATE AND '2023-12-31'::DATE)
);
...
CREATE TABLE CATEGORIA (
    ...
    CONSTRAINT chk_categoria_formato CHECK (nombre_categoria ~ '^[A-Za-z ]+$')
);
